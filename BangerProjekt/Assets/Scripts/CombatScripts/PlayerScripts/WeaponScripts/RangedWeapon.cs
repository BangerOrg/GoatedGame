...
public class RangedWeapon : Weapon
{
    ...
    public override void Shoot(int bulletCount)
    {
        ...
        {
            ShootingMiddle.transform.Rotate(0,0,Random.Range((-SpreadAngle * Player.Instance.BonusSpreadAngle),(SpreadAngle * Player.Instance.BonusSpreadAngle) + 1));
            bulletsLeft--;
            ...
            newBullet.GetComponent<Rigidbody2D>().AddForce(ShootingPoint.up * ShotSpeed * Player.Instance.BonusShotSpeed, ForceMode2D.Impulse); //add the velocity in the direction it should go
